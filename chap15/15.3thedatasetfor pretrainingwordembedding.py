...
def batchify(data):
    ...
    data内数据结构:最外层list，每个成员(a,b,c),a是中心词，b是上下文词列表，c是nagetive词列表"""
    ...
    for center, context, negative in data:
        ...
        masks += [[1] * cur_len + [0] * (max_len - cur_len)]#表示有效数据的掩码
        labels += [[1] * len(context) + [0] * (max_len - len(context))]#标识上下文数据的掩码
...
#batch是元组tuple=4，第一维2*1,数据是两个1，表示中心词，第二维是2*6，就是[223333][222330]表示上下文和nagetive
#第三维是2*6,[111111][111110]表示mask有效数据掩码 第四维 [110000][111000]是上下文有效数据掩码
