...
class Seq2SeqAttentionDecoder(AttentionDecoder):
    ...
    def init_state(self, enc_outputs, enc_valid_lens):
        ...
        outputs, hidden_state,_ = enc_outputs
    ...
    def forward(self, X, state):#state源于encoder的
        ...
        for x in X:
            ...
            query = torch.unsqueeze(hidden[-1], dim=1)#只用最后一层做注意力的Query,
            ...
            out, (hidden,cell) = self.rnn(x.permute(1, 0, 2), (hidden,cell))#rnn的前向获得当前时间步的token特征,并更新hidden_state,此时多层状态传入
            outputs.append(out)
        ...
        return outputs.permute(1, 0, 2), [enc_outputs, (hidden,cell),
                                          enc_valid_lens]
