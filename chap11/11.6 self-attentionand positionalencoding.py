...
batch_size, num_queries, valid_lens = 2, 4, torch.tensor([3, 2])#num_queries就是num_steps
...
#heatmaps里要求输入是 4 维张量，维度定义为：[num_rows, num_cols, y_size, x_size]，q其中num_rows,num_cols都是图片数量维度
#如果用seaborn只需要后两维即可
plt.show()
for i in range(8):
